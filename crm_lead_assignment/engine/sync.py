...
from crm_lead_assignment.integrations.team import sync_lead_team
...
def sync_assignment_helpers(
	...
	*,
	...
	if sync_team is None:
		sync_team = bool(settings.sync_team)
	...
	if sync_team:
		team = sync_lead_team(lead, owner, team)
